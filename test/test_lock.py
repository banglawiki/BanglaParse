...
tokrs1 = [banglaparse.Tokenizer() for n in range(5)]
tokrs2 = [banglaparse.Tokenizer('../extra_dict/dict.txt.small') for n in range(5)]
...
tokr1 = banglaparse.Tokenizer()
tokr2 = banglaparse.Tokenizer('../extra_dict/dict.txt.small')
